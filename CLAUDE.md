...
- Form 6781: supports both `Contract1256` (individual contracts) and `Realized1256`/`Unrealized1256` (aggregate broker amounts) in 1099 input. No .keys/.fields for 2025 yet (computation only, no PDF fill).
